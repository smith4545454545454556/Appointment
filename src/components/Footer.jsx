    ...
    return (
        <div className=' md:mx-10'>
            <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 text-sm'>
                {/* left side */}
                <div className=' '>
                    <img className=' mb-5 w-40' src={assets.hospital} />
                    <p className=' w-full text-gray-600 md:w-2/3 leading-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <hr />
            <p className=' text-sm text-center py-5 text-gray-700'> Copyright 2024@ appointment- All Right Reserved </p>
        </div>
    )
}
